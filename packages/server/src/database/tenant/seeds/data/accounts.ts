...
export const AccountsData = [
  ...
  OtherChargesAccount,
  {
    ...
    parent_account_id: null,
    code: '99001',
    description: 'Use this account for transactions you are unsure how to categorize.',
    active: 1,
    index: 1,
    predefined: 1,
  },
  {
    name: 'Ask My Accountant Income',
    slug: 'ask-my-accountant-income',
    account_type: 'income',
    parent_account_id: null,
    code: '99002',
    description: 'Use this account for income transactions you are unsure how to categorize.',
    active: 1,
    index: 1,
    predefined: 1,
  },
