...
export const getDashboardRoutes = () => [
  ...
  // Partners
  {
    ...
    component: lazy(() => import('@/containers/Partners/PartnerFormPage')),
  ...
  {
    path: `/partners`,
    component: lazy(() => import('@/containers/Partners/PartnersList')),
    pageTitle: 'Partners',
  },
  // Others
  {
    path: `/others/:id/edit`,
    component: lazy(() => import('@/containers/Others/OtherFormPage')),
    pageTitle: 'Edit Other',
    backLink: true,
  },
  {
    path: `/others/new`,
  ...
  {
    path: `/others`,
    component: lazy(() => import('@/containers/Others/OthersList')),
    pageTitle: 'Others',
  },
  // Vendors
  {
